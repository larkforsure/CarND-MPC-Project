...
const size_t acc_start    = delta_start + N - 1; // delta & acc has 1 less element
...
class FG_eval {
    public:
        ...
        void operator()(ADvector& fg, const ADvector& vars) {
            ...
            // Costs
            //
            // the first element of fg save the total cost
            fg[0] = 0;
            ...
            // use the physical model to caculate the rest of the constraints
